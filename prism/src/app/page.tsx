        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroLeft}>
            ...
            <div className={styles.heroBtnRow}>
              ...
              <a href="https://drive.google.com/file/d/1126Le9OF1hfUxc2F5IJBOdBqOjujBxXq/view?usp=sharing" target="_blank" rel="noopener noreferrer" className={styles.secondaryCtaBtn}>
              ...
              <a href="https://github.com/DhanviND360/PRISM_SIH2026" target="_blank" rel="noopener noreferrer" className={styles.githubBtn} aria-label="View on GitHub">
